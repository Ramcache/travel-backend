...
func NewServeCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			r := server.NewRouter(application.AuthHandler, application.UserHandler, application.CurrencyHandler, application.TripHandler, application.NewsHandler, application.ProfileHandler, cfg.JWTSecret, log)
